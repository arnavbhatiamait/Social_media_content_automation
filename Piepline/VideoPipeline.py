    ...
    def create_video(self, prompt: str = None, output_dir: str = "output") -> tuple[str | None, dict]:
        ...
        try:
            ...
            if use_veo:
                ...
                # Use the first scene's detailed prompt generated by the LLM (or prompt fallback)
                ...
                logger.info("VEO is disabled. Using traditional 5-scene image/audio concatenation pipeline...")
