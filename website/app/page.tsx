  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center bg-[#070913] text-zinc-100 overflow-hidden font-sans">
      ...
      <main className="relative z-10 text-center px-6 max-w-2xl space-y-8 flex flex-col items-center">
        ...
        <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-violet-600 to-fuchsia-500 flex items-center justify-center shadow-[0_0_30px_rgba(139,92,246,0.45)] mb-2 select-none">
          <span className="text-white font-black text-2xl tracking-tighter">AG</span>
        </div>

        <div className="space-y-4">
          <span className="px-3 py-1 rounded-full bg-violet-950/30 border border-violet-900/40 text-violet-400 text-xs font-semibold tracking-wider uppercase font-mono">
        ...
        <div className="flex justify-center gap-4 pt-4">
          <Link
            href="/dashboard"
            className="px-6 py-3.5 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500 text-white font-semibold text-sm shadow-[0_4px_25px_rgba(139,92,246,0.35)] transition-all hover:scale-[1.03] active:scale-[0.97]"
          >
